...
function renderWallet() {
  ...
  document.getElementById('walletSummary').innerHTML = `
    ...
    <div class="wallet-card"><div class="wallet-value">${assets.length + debts.length}</div><div class="wallet-label">Ligne${(assets.length+debts.length)>1?'s':''} au total</div></div>
  `;
